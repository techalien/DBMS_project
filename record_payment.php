        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                    <blockquote>
                        <h1>Add Payment Record</h1></blockquote>
                     <br>
			<div class="panel panel-primary">
    			<div class="panel-heading">Payment update</div>
    			<div class="panel-body">
                        <form class="form-horizontal" action="form_payment.php" method="get">
                        <div class="form-group">
			<label for="Name" class="col-sm-2 control-label">This member:</label>
			<div class="col-sm-5">
...
<div class="col-sm-12">
<button type="submit" class="btn btn-primary btn-block"><span class="glyphicon glyphicon-ok"></span> Commit payment</button>
</div>
</div>
</div>
</div>
